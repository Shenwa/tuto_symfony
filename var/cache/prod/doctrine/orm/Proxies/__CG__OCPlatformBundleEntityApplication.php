...
class Application extends \OC\PlatformBundle\Entity\Application implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Application' . "\0" . 'advert', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Application' . "\0" . 'id', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Application' . "\0" . 'author', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Application' . "\0" . 'content', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Application' . "\0" . 'date'];
        }
